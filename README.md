...
# Post Scriptum:
- Further steps of this projects will be considered:
    - RNN-EM with Bernoulli parameterization for pixels in data  
    - the use of the RNN-EM algorithm with a different losses.
    - other (static) state-of-the-art data set. 
    - trainer class to manage the early stopping in the training loop. 

- Datasets considered by authors can be found here: https://www.dropbox.com/sh/1ue3lrfvbhhkt6s/AAB6WiZzH_mAtCjW6b9okMGea?dl=0.
