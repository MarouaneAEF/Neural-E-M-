...
class rnn_em:
    ...
    def compute_probs(self, predictions, data):
        ...
        # for each value x in data and the corresponding value mu_x in mu, 
        # the code computes the probability p(x| mu, sigma)
    ...
    def e_step(self, predictions , targets):
        ...
        # the total probability of each observation in the input data being generated by any of the mixture components.
